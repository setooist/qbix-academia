            ...
            {events.map((event) => {
                ...
                return (
                    ...
                    <LinkWrapper
                        ...
                        {...linkProps}
                        className={`group flex flex-col rounded-lg shadow-sm border border-gray-100 overflow-hidden h-full relative ${accessible ? 'bg-white hover:shadow-md transition-shadow' : 'bg-gray-50 opacity-90 cursor-not-allowed'}`}
                    >
