...
export default function EventManagementListPage() {
    ...
    }, [permLoading, isEventManager, router, fetchEvents, lang]);
                ...
                <div>
                    ...
                    <div className="grid gap-4">
                        {upcomingEvents.map((event) => (
                            <EventCard key={event.id} event={event} formatDate={formatDate} formatTime={formatTime} lang={lang} />
                        ))}
                    </div>
                </div>
            )}
...
function EventCard({ event, formatDate, formatTime, isPast = false, lang }: EventCardProps) {
    return (
            ...
            <CardContent className="p-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Link href={`/${lang}/admin/events/${event.documentId || event.id}`}>
                            <Button size="sm">
